...
Route::middleware([
    ...
    Route::put('/user/profile-information', [UpdateUserProfileInformationController::class, 'update'])
        ->name('user-profile-information.update');

    // Livewire upload routes (add these for Railway compatibility)
    Route::post('/livewire/upload-file', '\Livewire\Mechanisms\HandleRequests\HandleRequests@uploadFile')
        ->name('livewire.upload-file');
    
    Route::post('/livewire/preview-file/{filename}', '\Livewire\Mechanisms\HandleRequests\HandleRequests@previewFile')
