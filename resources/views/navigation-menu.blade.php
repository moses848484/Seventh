<nav x-data="{ open: false }" class="">
    ...
    <!-- Offcanvas Header -->
    <div class="offcanvas-header border-bottom d-flex justify-content-between align-items-center px-3 py-3">
        <h5 id="offcanvasMenuLabel" class="fw-bold mb-0">Menu</h5>
        <!-- Custom close button with proper spacing -->
        <button type="button" class="btn btn-sm p-2 ms-auto" data-bs-dismiss="offcanvas" aria-label="Close"
            style="border: none; background: transparent; min-width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
