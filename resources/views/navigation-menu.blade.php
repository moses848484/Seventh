<nav x-data="{ open: false }" class="bg-white shadow">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-6">
                <!-- Hamburger Menu (visible on md+ only) -->
                <button class="text-gray-600 hover:text-gray-800 focus:outline-none md:inline-flex hidden"
                    @click="open = !open">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body">
            ...
            <!-- Profile section, links, dashboard, etc. -->
            {{-- Include your mobile menu here as you already built --}}
        </div>
    </div>
</nav>
