...
<body>
                        ...
                        <div class="px-3 py-1">
                            <div class="nav-item">
                                <a class="nav-link d-flex align-items-center py-2 px-3 rounded {{ request()->is('view_members') || request()->is('see_members') || request()->is('update_member/*') ? 'bg-success text-white' : 'text-dark' }}"
                                    ...
                                    <i class="fa-solid fa-chevron-down small collapse-arrow"></i>
                                </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Handle Bootstrap 5 collapse functionality with arrow rotation
            const collapseElements = document.querySelectorAll('.collapse');
            
            collapseElements.forEach(function(collapseEl) {
                const trigger = document.querySelector(`[data-bs-toggle="collapse"][href="#${collapseEl.id}"]`);
                const arrow = trigger ? trigger.querySelector('.collapse-arrow') : null;
                
                // Set initial arrow state
                if (collapseEl.classList.contains('show') && arrow) {
